...
class EnhancedKGParser(Model):
    ...
    def __init__(
        ...
        interpolation_constant: float = 0.9,
        ...
        **kwargs,
        ...
        self._word_encoder = word_encoder # if we are using a transformer, we do not normally use a second encoder, e.g. a BiLSTM
    ...
    def forward(
        ...
        predicted_head_tags: torch.LongTensor = None,
        predicted_head_indices: torch.LongTensor = None,     
        ...
        if self._word_embedder:
            ...
            embedded_words = self._input_dropout(embedded_words)
        ...
        if enhanced_tags is not None:
            ...
            # interpolate between arc and tag losses
            arc_loss = (1 - self.interpolation_constant) * arc_nll
            tag_loss = self.interpolation_constant * tag_nll
            ...
            predicted_arcs = output_dict["arc_indices"]
