...
for ((i=0;i<${#HIGH_MEMORY_TBIDS[@]};++i)); do
    ...
    sbatch -J eud_high_mem --gres=gpu:rtx6000:1 ./scripts/train_eud_multitask_parser.sh ${TBID} enhanced transformer ${MODEL} enhanced_kg_parser dependencies-enhanced_dependences ${DELEX_TYPE}
...
for ((i=0;i<${#MEDIUM_TBIDS[@]};++i)); do
    ...
    # sbatch -p long --gres=gpu:rtx6000:1 ./scripts/train_eud_parser.sh en_ewt enhanced transformer xlm-roberta-base enhanced_kg_parser transformer
   sbatch -J eud_medium --gres=gpu:rtx6000:1 ./scripts/train_eud_multitask_parser.sh ${TBID} enhanced transformer ${MODEL} enhanced_kg_parser dependencies-enhanced_dependences ${DELEX_TYPE}
done
...
for ((i=0;i<${#SHORT_TBIDS[@]};++i)); do
    ...
    sbatch -J eud_short --gres=gpu:rtx2080ti:1 ./scripts/train_eud_multitask_parser.sh ${TBID} enhanced transformer ${MODEL} enhanced_kg_parser dependencies-enhanced_dependences ${DELEX_TYPE}
done