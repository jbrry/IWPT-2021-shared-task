...
@Head.register("enhanced_kg_parser")
class EnhancedKGParser(Head):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.interpolate_losses = interpolate_losses
